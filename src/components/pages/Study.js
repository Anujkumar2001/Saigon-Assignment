...
export const Study = () => {
    return (
        <div><Breadcrumb/>
            ...
            <section class="tl-9-services tl-9-section-spacing bg-defaults" data-background="/assets/images/tl-9/service-bg.jpg" style={{ backgroundImage: `url(/assets/images/tl-9/service-bg.jpg)` }}>
                <div class="container">
                    <div class="tl-9-section-heading">
                        <div class="row gy-4 align-items-center">
                            <div class="col-md-7">
                                <h2 class="tl-9-section-title" data-text="Our Services">We Give You The Best Facilities For Learning.</h2>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-3 col-md-4 col-6 col-xxs-12">
                            <div class="tl-9-service">
                                <img class="tl-9-service-icon" src="/assets/images/tl-9/service-1.png" alt="Icon" />
                                <h4 class="tl-9-service-title">Double Bass</h4>
                                <p class="tl-9-service-descr">Lorem ipsum dolor consectetu adipescent maximus libero.</p>
                        ...
                        <div class="col-lg-3 col-md-4 col-6 col-xxs-12">
                            <div class="tl-9-service">
                                <img class="tl-9-service-icon" src="/assets/images/tl-9/service-4.png" alt="Icon" />
                                <h4 class="tl-9-service-title">Drums</h4>
                                <p class="tl-9-service-descr">Lorem ipsum dolor consectetu adipescent maximus libero.</p>
                        ...
                        <div class="col-lg-3 col-md-4 col-6 col-xxs-12">
                            <div class="tl-9-service">
                                <img class="tl-9-service-icon" src="/assets/images/tl-9/service-2.png" alt="Icon" />
                                <h4 class="tl-9-service-title">Saxophone</h4>
                                <p class="tl-9-service-descr">Lorem ipsum dolor consectetu adipescent maximus libero.</p>
                        ...
                        <div class="col-lg-3 col-md-4 col-6 col-xxs-12">
                            <div class="tl-9-service">
                                <img class="tl-9-service-icon" src="/assets/images/tl-9/service-3.png" alt="Icon" />
                                <h4 class="tl-9-service-title">Violoncello</h4>
                                <p class="tl-9-service-descr">Lorem ipsum dolor consectetu adipescent maximus libero.</p>
            ...
            <section class="tl-3-events tl-3-section-spacing pb-50">
                <div class="container">
                    <h2 class="tl-4-section-title">Upcoming  <span class="last-word">Events</span></h2>
                            ...
                            <div class="col-md-6">
                                <div class="tl-3-single-event">
                                    ...
                                    <div class="tl-3-single-event-txt">
                                        ...
                                        <h3 class="tl-3-single-event-title">Connecting Education and Real-World Challenges.</h3>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="tl-3-single-event">
                                    ...
                                    <div class="tl-3-single-event-txt">
                                        ...
                                        <h3 class="tl-3-single-event-title">Learning Digital Adapting Education for the 21st Century.</h3>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="tl-3-single-event">
                                    ...
                                    <div class="tl-3-single-event-txt">
                                        ...
                                        <h3 class="tl-3-single-event-title">Education Fostering Inclusivity and Understanding.</h3>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="tl-3-single-event">
                                    ...
                                    <div class="tl-3-single-event-txt">
                                        ...
                                        <h3 class="tl-3-single-event-title">Empowering Minds: Unleashing the Potential of Education.</h3>
                                    </div>
                                </div>
                            </div>
